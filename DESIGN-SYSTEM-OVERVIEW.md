...
- **New in Portal 1.11 "Dusk" (dark-first restyle)** — **dark is the default theme** (first-run pref
  `dark`; softened dark neutrals — ink `#F2F2F4`, surface `#1D1D21`, shell `#161619`; every preview
  bootstraps dark-first); the **Dusk palette** — primary `#1861AF` light / `#ADBDD1` dusty-steel dark
